<%@ Page Language="C#" MasterPageFile="~/OwnerMaster.master" AutoEventWireup="true" CodeFile="OwnerFilesView1.aspx.cs" Inherits="OwnerFilesView1" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table style="width: 94%">
        ...
        <tr>
            <td>
                <asp:Panel style="position:absolute; width: 808px;  top: 560px; left: 46px; height: 354px;" 
           ...
           <asp:TextBox style="position: absolute; top: 74px; left: 324px; width: 180px" ID="TextBox2" 
            ...
            <asp:LinkButton ID="LinkButton2" runat="server" 
                ...
                Font-Size="Small" ToolTip="Click ang Get Key" onclick="LinkButton2_Click">OFFLINE</asp:LinkButton>
                    <asp:TextBox ID="TextBox3" runat="server" Enabled="false" 
                        style="position: absolute; top: 113px; left: 326px; width: 180px"></asp:TextBox>
